...
def main():
    ...
    utils.plot_distribution(results, "portion of points that appear in Nth or more imgs mesuared by descriptors", "y_2",
    ...
    for method in methods:
        ...
        results[method] = {"time": local_result[1] * 1000000, "repeatability": rep, "x": x_1, "y_1": y_1, "y_2": y_2}
        print(method, "{:.2f}".format(results[method]["repeatability"]))
        utils.plot_distribution(results, "portion of points that appear in Nth or more imgs mesuared by motion estimation",
